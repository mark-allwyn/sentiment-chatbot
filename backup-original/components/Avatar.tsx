  ...
  const getColor = () => {
    switch (sentiment) {
      case SentimentState.POSITIVE:
        return '#4ade80'; // Green (using Tailwind green-400 for a softer look)
      case SentimentState.NEGATIVE:
        return '#f87171'; // Red (using Tailwind red-400)
      case SentimentState.NEUTRAL:
      default:
        return '#fb923c'; // Orange (using Tailwind orange-400)
    }
  };
  ...
  return (
    <div className="relative w-48 h-48 mx-auto transition-all duration-500 ease-in-out transform hover:scale-105">
      <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-lg">
        ...
        {/* Subtle inner highlight/gradient effect for depth */}
        <circle 
          cx="100" 
          cy="100" 
          r="80" 
